...
lands :: [Land]
lands = [
         Land 0 Build "Mediterranean Avenue" 1 [2,10,30,90,160,250] 50 0 Brown 60 30 False ,
         Land 0 Build "Baltic Avenue" 3 [4,20,60,180,320,450] 50 0 Brown 60 30 False ,
         Land 0 Build "Oriental Avenue" 6 [6,30,90,270,400,550] 50 0 LightBlue 100 50 False ,
         Land 0 Build "Vermont Avenue" 8 [6,30,90,270,400,550] 50 0 LightBlue 100 50 False ,
         Land 0 Build "Connecticut Avenue" 9 [8,40,100,300,450,600] 50 0 LightBlue 120 60 False ,
         Land 0 Build "St Charles Place" 11 [10,50,150,450,625,750] 100 0 Pink 140 70 False ,
         Land 0 Build "States Avenue" 13 [10,50,150,450,625,750] 100 0 Pink 140 70 False ,
         Land 0 Build "Virginia Avenue" 14 [12,60,180,500,700,900] 100 0 Pink 160 80 False ,
         Land 0 Build "St James Place" 16 [14,70,200,550,750,950] 100 0 Orange 180 90 False ,
         Land 0 Build "Tennessee Avenue" 18 [14,70,200,550,750,950] 100 0 Orange 180 90 False ,
         Land 0 Build "New York Avenue" 19 [16,80,220,600,800,1000] 100 0 Orange 200 100 False ,
         Land 0 Build "Kentucky Avenue" 21 [18,90,250,700,875,1050] 150 0 Red 220 110 False ,
         Land 0 Build "Indiana Avenue" 23 [18,90,250,700,875,1050] 150 0 Red 220 110 False ,
         Land 0 Build "Illinois Avenue" 24 [20,100,300,750,925,1100] 150 0 Red 240 120 False ,
         Land 0 Build "Atlantic Avenue" 26 [22,110,330,800,975,1150] 150 0 Yellow 260 130 False ,
         Land 0 Build "Ventnor Avenue" 27 [22,110,330,800,975,1150] 150 0 Yellow 260 130 False ,
         Land 0 Build "Marvin Gardens" 29 [24,120,360,850,1025,1200] 150 0 Yellow 280 140 False ,
         Land 0 Build "Pacific Avenue" 31 [26,130,390,900,1100,1275] 200 0 Green 300 150 False ,
         Land 0 Build "North Carolina Avenue" 32 [26,130,390,900,1100,1275] 200 0 Green 300 150 False ,
         Land 0 Build "Pennsylvania Avenue" 34 [28,150,450,1000,1200,1400] 200 0 Green 320 160 False ,
         Land 0 Build "Park Place" 37 [35,175,500,1100,1300,1500] 200 0 DarkBlue 350 175 False ,
         Land 0 Build "Boardwalk" 39 [50,200,600,1400,1700,2000] 200 0 DarkBlue 400 200 False 
        ]
...
updateBoard [] _ = error "shit happened at update board"
updateBoard (x:xs) novo
  | identifier x == identifier novo = novo:xs
  | otherwise = x:updateBoard xs novo

serializedUpdateBoard :: [RealTile] -> [RealTile] -> [RealTile]
serializedUpdateBoard = foldl updateBoard --og first changed ones second
--serializedUpdateBoard :: [RealTile] -> [RealTile] -> [RealTile]
--serializedUpdateBoard og chn = updateBoard' ogo chno
--  where
--    updateBoard' [] [] = []
